  ...
  it("defines all required principle summary pages with key sections and source links", () => {
    ...
    for (const section of principlesSections) {
      ...
      for (const anchor of section.sourceAnchors) {
        expect(anchor.href.startsWith("https://github.com/adthomps/apt-principles-agents/blob/main/apt-principles-agents/")).toBe(true);
      }
      ...
      expect(section.sourceHref.startsWith("https://github.com/adthomps/apt-principles-agents/blob/main/apt-principles-agents/")).toBe(true);
