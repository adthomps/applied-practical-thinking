...
# Project Profile Validation Sweep 2026-06-13
...
| apt-agent-standards | skipped | project-profile.json not found |
...
| apt-anet-integration-toolbox | failed | Invalid showcase object: expected { include: boolean, summary: string } |
| apt-coach | skipped | project-profile.json not found |
| apt-commerce | failed | Missing required keys: project, purpose, audience, adoption_mode, principles_demonstrated, maturity, showcase; Invalid adoption_mode: undefined |
...
| apt-exercise | skipped | project-profile.json not found |
