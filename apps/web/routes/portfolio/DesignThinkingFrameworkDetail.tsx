        ...
        <AptCard variant="default" padding="large">
          ...
          <AptCardContent>
            <div className="space-y-5">
              <div>
                <AptTag variant="outline" size="sm" className="mb-2">When to use</AptTag>
                <p className="text-sm text-muted-foreground">{entry.when}</p>
              </div>
              <div>
                <AptTag variant="outline" size="sm" className="mb-3">Core process</AptTag>
        ...
        <AptCard variant="feature" padding="large">
          <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <AptTag variant="outline" size="sm" className="mb-2">Design Thinking</AptTag>
