    ...
    <div className="container py-12 md:py-16 space-y-16">
      <section>
        <SectionIntro
          ...
          description="The canonical model for how APT moves from intent to operation: Why, What, How, Consistency, Build, Validate, Promote, Run, Learn, and the AI augmentation layer across all of it."
      ...
      <section>
        <SectionIntro
          ...
          description="Each group has explicit focus, enforcement principles, and expected outputs."
          className="mb-6"
        />
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {aptPrincipleGroups.map((group) => {
            ...
            return (
              <AptCard key={group.id} variant="interactive" padding="large">
                <AptCardHeader className="p-0">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      ...
                      <AptCardTitle className="text-xl">{group.title}</AptCardTitle>
                    </div>
                  </div>
                </AptCardHeader>
      ...
      <section>
        ...
        <AptCard variant="feature" padding="large">
          <AptCardHeader className="p-0">
            ...
            <AptCardDescription>
              {"Thinking -> Design -> Architecture -> System -> Execution -> Quality -> Release -> Operations -> Knowledge"}
            </AptCardDescription>
          </AptCardHeader>
          <AptCardContent className="p-0 mt-6 space-y-4">
              ...
              {aptLifecycleFlow.map((id, index) => {
                ...
                return (
                  <div key={id} className="flex items-center gap-2">
                    <AptTag variant="secondary">{group.title}</AptTag>
            ...
            <div className="rounded-lg border border-border/60 bg-background/50 p-4">
              <p className="text-sm text-muted-foreground">
                <span className="font-medium text-foreground">{aptPrincipleGroupsById[aptAiOverlayGroupId].title}</span>
