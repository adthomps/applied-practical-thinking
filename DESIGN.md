...
This root file is a pointer, not the canonical design spec.
...
- Shared TypeScript token contracts: `packages/config`
- App-specific composition and route UI: `apps/web`
