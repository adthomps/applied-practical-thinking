...
- apt-principles/context-packs/README.md
- apt-principles/references/apt-application-model.json
...
6. Preserve the apt-principles / apt-agent-standards ownership split.
...
- Do not merge `apt-agent-standards` installer, profile detection, or path-mapping behavior into `apt-principles`.
