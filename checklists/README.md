---
title: Local Checklists Surface
version: v1
status: draft
audience: developer
visibility: internal
...
- Do not fork canonical checklists unless an approved decision log records an exception.
- Store repo-specific operational checklists in docs/ when they are not doctrine-wide.
