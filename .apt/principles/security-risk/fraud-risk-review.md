...
source_paths: ["apt-principles-agents/principles/security-risk/fraud-risk-review.md"]
---
...
- Treat **Fraud Risk Review** as an explicit decision with defined scope, evidence, owner, and validation.
- Separate detection signals, decision rules, explainability, false positives, overrides, and monitoring.
