...
domain: "api"
source_paths: ["apt-principles-agents/principles/api/json-first-design.md"]
---
...
- Treat **Json First Design** as an explicit decision with defined scope, evidence, owner, and validation.
- Use explicit schemas, canonical field types, examples, nullability, extensibility, and deterministic validation.
